...
if not EspSettings1 then
	getgenv().EspSettings1 = {
		TeamCheck = false,
		ToggleKey = "RightAlt",
...
getgenv().EspSettings1.Names.OutlineThickness = 0 -- to make setall work
...
local ss, mousevis, highlights, npcs = getgenv().EspSettings1, getgenv().EspSettings1.MouseVisibility, getgenv().EspSettings1.Highlights, getgenv().EspSettings1.NPC
